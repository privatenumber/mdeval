...
- Runtime stack traces from a `.md` remap to its original line and column automatically — the loader enables Node's source-map support. Syntax errors do not remap — Node fails before reading the inline map.
